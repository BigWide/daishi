...
def dataprocessIntel(rec):
	'''
	print('%02X' % rec.uID),
	print('%02X' % rec.arryData[0]),
	print('%02X' % rec.arryData[1]),
	print('%02X' % rec.arryData[2]),
	print('%02X' % rec.arryData[3]),
	print('%02X' % rec.arryData[4]),
	print('%02X' % rec.arryData[5]),
	print('%02X' % rec.arryData[6]),
	print('%02X' % rec.arryData[7])
	'''
...
def parseData(rec):
	...
	elif rec.uID==0x607: #HeadingPitchRoll
	...
	elif rec.uID==0x608: #AngRateVehicle
	...
	elif rec.uID==0x609: #AngRateLevel
	...
	elif rec.uID==0x60b: #AngAccelLevel
...
def ds():
	...
	while not rospy.is_shutdown():
		reclen1 = clib.CAN_ChannelReceive(dwDeviceHandle, 0 , byref(rec1), 22, 20)
		reclen2 = clib.CAN_ChannelReceive(dwDeviceHandle, 1, byref(reclist), 10, 10)
		reccount1 = reccount1 + reclen1
		reccount2 = reccount2 + reclen2
		parseData(rec1)
		vehicle_state(reclist)
		if reccount1%22==0:
...
if __name__ == '__main__':
	...
	dwDeviceHandle = clib.CAN_DeviceOpen(2,0,0)
